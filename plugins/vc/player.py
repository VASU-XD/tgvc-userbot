...
- Repository: [GitHub](https://github.com/v1su)
- Modified By: [ᴠᴀꜱᴜ](https://t.me/VasuXD)
...
async def network_status_changed_handler(context, is_connected: bool):
    if is_connected:
        ...
        await send_text(f"{emoji.CHECK_MARK_BUTTON}")
    else:
        await send_text(f"{emoji.CROSS_MARK_BUTTON}")
        mp.chat_id = None
